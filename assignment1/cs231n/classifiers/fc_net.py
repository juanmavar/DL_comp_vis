...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, scores_cache = affine_forward(s1, self.params['W2'], self.params['b2'])
        ...
        ds1, grads['W2'], grads['b2'] = affine_backward(dscores, scores_cache)
        dX, grads['W1'], grads['b1'] = affine_relu_backward(ds1, s1_cache)
