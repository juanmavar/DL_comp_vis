...
def make_fooling_image(X, target_y, model):
    ...
    for i in range(100):
      score = model(X_fooling)[0,target_y]
      
      score.backward()

      gradiente = X_fooling.grad.data
      dX = learning_rate * gradiente / gradiente.norm()
      X_fooling.data += dX
...
def class_visualization_update_step(img, model, target_y, l2_reg, learning_rate):
    ...
    gradiente = img.grad.data - l2_reg * 2 * img.data
    dimg = learning_rate * gradiente
    img.data += dimg
    img.grad.data.zero_()
